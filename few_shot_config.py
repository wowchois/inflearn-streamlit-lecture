...
만약 퇴사자가 원청징수영수증을 요청한다면 지체없이 바로 발급해야 합니다"""
    ...
    {
        "input": "연간 소득이 5,500만원인 직장인의 평균 종합 소득세를 계산 할 수 있나요?", 
        "answer": """소득세법 제55조(세율)에 따르면, 
과세표준 구간 5,000만원 초과 ~ 8,800만원 이하인 경우, 624만원 + (5,000만원을 초과하는 금액의 24퍼센트)의 세율이 적용됩니다.
따라서 직장인의 평균 종합소득세는 655만원입니다."""
    },
]